...
// Validate checks the field values on SleepApplicationRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *SleepApplicationRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SleepApplicationRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SleepApplicationRequestMultiError, or nil if none found.
func (m *SleepApplicationRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *SleepApplicationRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if utf8.RuneCountInString(m.GetApplicationName()) < 1 {
		err := SleepApplicationRequestValidationError{
			field:  "ApplicationName",
			reason: "value length must be at least 1 runes",
		}
		if !all {
	...
	if len(errors) > 0 {
		return SleepApplicationRequestMultiError(errors)
	}
	return nil
}

// SleepApplicationRequestMultiError is an error wrapping multiple validation
// errors returned by SleepApplicationRequest.ValidateAll() if the designated
// constraints aren't met.
type SleepApplicationRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SleepApplicationRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SleepApplicationRequestMultiError) AllErrors() []error { return m }

// SleepApplicationRequestValidationError is the validation error returned by
// SleepApplicationRequest.Validate if the designated constraints aren't met.
type SleepApplicationRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SleepApplicationRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SleepApplicationRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SleepApplicationRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SleepApplicationRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SleepApplicationRequestValidationError) ErrorName() string {
	return "SleepApplicationRequestValidationError"
}

// Error satisfies the builtin error interface
func (e SleepApplicationRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSleepApplicationRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SleepApplicationRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SleepApplicationRequestValidationError{}
