...
var file_playground_apps_services_proto_rawDesc = []byte{
	...
	0x6f, 0x32, 0x68, 0x0a, 0x04, 0x41, 0x70, 0x70, 0x73, 0x12, 0x60, 0x0a, 0x04, 0x4c, 0x69, 0x73,
	0x74, 0x12, 0x1f, 0x2e, 0x70, 0x6c, 0x61, 0x79, 0x67, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x5f, 0x63,
	0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x20, 0x2e, 0x70, 0x6c, 0x61, 0x79, 0x67, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x5f,
	0x61, 0x70, 0x70, 0x73, 0x2e, 0x41, 0x70, 0x70, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x15, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x0f, 0x12, 0x0d, 0x2f, 0x76,
	0x30, 0x2f, 0x61, 0x70, 0x70, 0x73, 0x2f, 0x6c, 0x69, 0x73, 0x74, 0x42, 0x45, 0x5a, 0x43, 0x67,
...
var file_playground_apps_services_proto_goTypes = []interface{}{
	(*grpc_playground_common_go.EmptyRequest)(nil), // 0: playground_common.EmptyRequest
	(*AppListResponse)(nil),                        // 1: playground_apps.AppListResponse
}
var file_playground_apps_services_proto_depIdxs = []int32{
	0, // 0: playground_apps.Apps.List:input_type -> playground_common.EmptyRequest
...
type AppsClient interface {
	...
	List(ctx context.Context, in *grpc_playground_common_go.EmptyRequest, opts ...grpc.CallOption) (*AppListResponse, error)
}
...
func (c *appsClient) List(ctx context.Context, in *grpc_playground_common_go.EmptyRequest, opts ...grpc.CallOption) (*AppListResponse, error) {
...
type AppsServer interface {
	// List returns a subset of applications found in the user cluster.
	List(context.Context, *grpc_playground_common_go.EmptyRequest) (*AppListResponse, error)
}
...
func (*UnimplementedAppsServer) List(context.Context, *grpc_playground_common_go.EmptyRequest) (*AppListResponse, error) {
...
func _Apps_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppsServer).List(ctx, req.(*grpc_playground_common_go.EmptyRequest))
	}
